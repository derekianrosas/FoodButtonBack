...
def insertBLOB(emp_id, name, photo, biodataFile):
    ...
    try:
        connection = mysql.connector.connect(host='ec2-34-192-173-173.compute-1.amazonaws.com',
        database='d9eg2abehv5ppe',
        user='nyjifrotlfgwbj',
        password='4d427557ea3920e6669a7fa76c058f7ab853c5e1559c430a45330ad0a17f479c')
